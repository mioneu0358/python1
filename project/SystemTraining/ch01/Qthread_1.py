...
from PyQt5.QtWidgets import *   # PyQt5 불러오기


class Thread1(QThread):
    def __init__(self,parent):      # 부모클래스의 윈도우 창을 가져올 수 있다.
        super().__init__(parent)    # 부모의 윈도우 창을 초기화  parent = main스크립트
        ...
        # ===================== 사용되는 변수 =====================
        self.Acc_Screen = '1000'            # 계좌평가잔고내역을 받기 위한 스크린
                                            # 스크린: 1 ~ 9999번까지 있으며 1개당 50개의 데이터를 저장할 수 있는 주머니
                                            # 먄약 60개의 종목을 저장하려면 2개의 스크린이 필요하고, 1개의 스크린에 60개의 종목을 넣게 되면 앞선 10개 데이터는 삭제된다.
    ...
    def trdata_slot(self, sScrNo, sRQName, sTrCode, sRecordName, sPrevNext):
        if sRQName == "계좌평가잔고내역요청":
            ...
            self.parent.stocklistTableWidget_2.setColumnCount(colCount)                             # 행 개수
            self.parent.stocklistTableWidget_2.setRowCount(rowCount)                                # 열 개수
