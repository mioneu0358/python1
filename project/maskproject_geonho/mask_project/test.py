...
if __name__ == "__main__":
    # 인천 미세먼지, 경기 미세먼지, 평균 미세먼지
    print(f"pm10_incheon: {pm10_incheon}, pm10_gyeonggi = {pm10_gyeonggi}, pm10_avg = {pm10_avg}")
    # 인천 초미세먼지, 경기 초미세먼지, 평균 초미세먼지
    print(f"pm25_incheon = {pm25_incheon}, pm25_gyeonggi = {pm25_gyeonggi}, pm25_avg = {pm25_avg}")